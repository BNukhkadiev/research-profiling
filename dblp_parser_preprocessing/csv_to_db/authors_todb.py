...
# Load CSV file path from an environment variable or use a default filename
csv_file = os.getenv("CSV_FILE_PATH", "authors_list.csv")
...
TABLE_NAME = os.getenv("TABLE_NAME", "authors")  # Change if needed
